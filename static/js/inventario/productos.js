...
document.querySelectorAll("[data-view-product]").forEach((button) => {
  button.addEventListener("click", () => {
    ...
    detailDialog.querySelector("[data-detail-stock]").textContent = `${button.dataset.stock} ${stockUnit}`;
    detailDialog.querySelector("[data-detail-stock-loose]").textContent = `${button.dataset.stockSuelto} ${stockUnit}`;
